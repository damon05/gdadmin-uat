...
angular.module('app')
    ...
    .controller('createSafeCategoryCtl', function ($http, $scope, enume, $state, $stateParams) {
        $scope.ID = "";
        $scope.Name = "";
        $scope.Intro = "";
        $scope.Sort = "";
        ...
        function getInfoByCode(){
            ...
            enume.getData(srvDomain + "/SafeCategory/Update?ID=" + id, function (item) {
                $scope.ID = item.ID;
        ...
        $scope.createSafeCategory = function () {
            ...
            if($stateParams.entity.tag == "edit"){
                var id = $stateParams.entity.item.ID;                
                url = srvDomain + "/SafeCategory/Update";
                tmp.id = id;
            }else{
                url = srvDomain + "/SafeCategory/Add";
            }          
            enume.postData(url,tmp,function(d){
                $state.go("roomManage.safeCategoryList");
            })
        }
    })

    .controller('safeCategoryListCtl', function ($http, $scope, enume, $state) { })
